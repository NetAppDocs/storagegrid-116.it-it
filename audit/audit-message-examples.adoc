...
44102530435]]
----
ATIM registra il tempo, in microsecondi, dall'inizio dell'epoca UNIX. Nell'esempio, il valore `1405631878959669` Tradotto a Giovedi, 17-lug-2014 21:17:59 UTC.
