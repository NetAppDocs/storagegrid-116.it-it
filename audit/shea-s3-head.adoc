...
summary: 'Quando un client S3 esegue una transazione HEAD, viene effettuata una richiesta per verificare l"esistenza di un oggetto o bucket e recuperare i metadati relativi a un oggetto. Questo messaggio viene emesso dal server se la transazione ha esito positivo.' 
---
= SHEA: TESTA S3
:allow-uri-read: 
:icons: font
