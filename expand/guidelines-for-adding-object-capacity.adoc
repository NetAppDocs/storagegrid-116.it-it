...
* È possibile aggiungere uno o due shelf di espansione a ciascuna appliance SG6060 o SG6060X. Ogni shelf di espansione aggiunge 16 volumi di storage. Con entrambi gli shelf di espansione installati, SG6060 e SG6060X possono supportare ciascuno un totale di 48 volumi di storage.
