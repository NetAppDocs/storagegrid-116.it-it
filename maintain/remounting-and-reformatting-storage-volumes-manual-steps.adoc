...
---
= Rimontare e riformattare i volumi di storage ("procedure manuali")
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
* Lo hai fatto xref:reviewing-warnings-for-system-drive-recovery.adoc[Esaminate le avvertenze relative al ripristino del disco di sistema Storage Node].
+
