...
== Risolvere gli errori "`422: Unprocessable Entity`"
...
== [[Troubleshooting_MTU_ALERT]]risoluzione dei problemi relativi all'avviso di mancata corrispondenza MTU della rete griglia
...
== Risolvere i problemi relativi all'allarme NRER (Network Receive Error)
...
.Informazioni correlate
<<troubleshoot_MTU_alert,Risolvere i problemi relativi all'avviso di mancata corrispondenza MTU della rete griglia>>
...
+
image::../media/node_overview_ip_addresses_ipv6.png[Panoramica degli indirizzi IP dei nodi]

* Selezionare *SUPPORT* *Tools* *Grid topology*. Quindi, selezionare *_node_* *SSM* *Resources*. Se è stato assegnato un indirizzo IPv6, questo viene elencato sotto l'indirizzo IPv4 nella sezione *indirizzi di rete*.
