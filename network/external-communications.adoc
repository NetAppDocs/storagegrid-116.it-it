...
NOTE: Questo elenco non include le porte che potrebbero essere configurate come xref:../admin/configuring-load-balancer-endpoints.adoc[endpoint del bilanciamento del carico].
