...
Per ulteriori informazioni, consultare https://docs.aws.amazon.com/AmazonS3/latest/API/API_SelectObjectContent.html["Documentazione AWS per SelectObjectContent"^].
