...
NOTE: È inoltre possibile configurare il sistema utilizzando xref:../admin/index.adoc[Grid Manager] o il xref:overview-of-installation-rest-apis.adoc[API di installazione].
