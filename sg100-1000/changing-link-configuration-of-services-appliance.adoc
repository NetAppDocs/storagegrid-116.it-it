...
+
Per ulteriori informazioni sulle opzioni, vedere xref:configuring-network-links-sg100-and-sg1000.adoc[Configurare i collegamenti di rete].
...
+
Se sono state apportate modifiche alle impostazioni della VLAN, la subnet dell'appliance potrebbe essere cambiata. Per modificare gli indirizzi IP dell'appliance, vedere xref:configuring-storagegrid-ip-addresses-sg100-and-sg1000.adoc[Configurare gli indirizzi IP StorageGRID].
