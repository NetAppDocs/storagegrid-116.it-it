...
summary: 'Il programma di installazione dell"appliance StorageGRID consente di configurare gli indirizzi IP e le informazioni di routing utilizzati per l"appliance di servizi nelle reti StorageGRID Grid, Admin e Client.' 
---
...
xref:changing-link-configuration-of-services-appliance.adoc[Modificare la configurazione del collegamento dell'appliance di servizi]
