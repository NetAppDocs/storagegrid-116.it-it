...
* (Facoltativo) per individuare il controller nel data center, xref:turning-controller-identify-led-on-and-off.adoc[Accendere il LED blu di identificazione].
