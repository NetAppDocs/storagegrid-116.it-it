...
Se si desidera modificare la configurazione del collegamento, consultare xref:changing-link-configuration-of-sg6000-cn-controller.adoc[Istruzioni per modificare la configurazione del collegamento del controller SG6000-CN].
